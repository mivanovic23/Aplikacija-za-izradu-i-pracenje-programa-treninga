<template>
  <div id="new-workout">
    <ul class="collection with-header">
      <li class="collection-header"><h4>New Workout</h4></li>
    <div class="row" >
    <form v-on:submit.prevent="saveWorkout" class="collection-item">
      <div class="row">
      ...
      <button type="submit" class="btn">Log your workout</button>
